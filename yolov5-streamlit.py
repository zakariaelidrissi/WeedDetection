...
if __name__ == '__main__':
    ...
    st.title('Weed Detection with YOLOv5')
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='best_weights_large.pt', help='model path(s)')
    ...
    if source_index == 0:
        ...
        if uploaded_file is not None:
            ...
            with st.spinner(text='loading...'):
                ...
                with open("data/videos/"+uploaded_file.name, "wb") as f:
